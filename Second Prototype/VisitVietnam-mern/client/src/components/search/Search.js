        ...
        return(
            <div className="Container Search">
                <div className="Container__Content">
                        ...
                        <div className="row member-list  ml-3 mr-3">
                            ...
                            <div className="col-sm-12 member-item">                                
                                <div key={thing.Id} className="member-item-content row">
                                    <img src={thing.attachment} alt={thing.attachment} className="member-img border-img col-sm-2 my-1"/>
                        ...
                        <div className="row member-list  ml-3 mr-3">
                            ...
                            <div className="col-sm-12 member-item">                                
                                <div key={foody.Id} className="member-item-content row">
                                    <img src={foody.attachment} alt={foody.attachment} className="member-img border-img col-sm-2 my-1"/>
                                    <div className="item-content m-0 p-3 col-sm-8">
                    ...
                    <div className="Content__Product mt-5">
                        <div className="Product">                                                     
                            <div className="Header d-inline">Fashion</div>
                        </div>
                        <div className="border-bottom"></div>
                        <div className="row member-list  ml-3 mr-3">
                            ...
                            <div className="col-sm-12 member-item">                                
                                <div key={item.Id} className="member-item-content row">
                                    <img src={item.attachment} alt={item.attachment} className="member-img border-img col-sm-2 my-1"/>
                                    <div className="item-content m-0 p-3 col-sm-8">
