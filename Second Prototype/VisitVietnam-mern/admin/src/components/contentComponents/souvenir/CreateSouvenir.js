...
export class CreateSouvenir extends Component {
  constructor(props) {
    super(props);
  ...
  handleSubmit(e) {
    ...
    e.preventDefault();
    axios
      .post(process.env.REACT_APP_API + "/souvenirs", data)
          ...
          <div id="layoutSidenav_content">
            <main>
              <div className="container-fluid">
                <h1 className="mt-4">Create new Souvenir</h1>
                <ol className="breadcrumb mb-4">
                  <li className="breadcrumb-item">
                    <a href="/">Master page</a>
                  </li>
                  <li className="breadcrumb-item active">Create new Souvenir</li>
                </ol>
