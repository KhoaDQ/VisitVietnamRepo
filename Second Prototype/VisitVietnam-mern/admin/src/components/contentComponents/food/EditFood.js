...
export class EditFood extends Component {
  ...
  refreshList() {
    fetch(process.env.REACT_APP_API + "/foods/" + this.state.foodId, {
      method: "GET",
    })
  ...
  handleSubmit(e) {
    ...
    e.preventDefault();
    axios
      .put(process.env.REACT_APP_API + "/foods", data)
      .then((res) => res.status)
      .then((result) => {
        alert(result);
      });
              ...
              <div class="container-fluid">
                ...
                <div class="card mb-4">
                  <div class="card-header">
                    <NavLink class="btn btn-success" to="/list_food">
                      Back to list
                    </NavLink>
                  </div>
                      ...
                      <Form onSubmit={this.handleSubmit}>
                        ...
                        <Form.Group controlId="Type">
                          ...
                          <Form.Control
                            ...
                            name="Type"
                            placeholder="Type"
                            defaultValue={this.state.food.Type}
                          />
                        </Form.Group>
                        ...
                        <Form.Group controlId="MiniType">
                          ...
                          <Form.Control
                            ...
                            defaultValue={this.state.food.MiniType}
                          />
                        </Form.Group>
                        ...
                        <Form.Group controlId="Note">
                          ...
                          <Form.Control
                            ...
                            name="Note"
                            placeholder="Note"
                            defaultValue={this.state.food.Note}
                          />
                        </Form.Group>
                        ...
                        <Form.Group controlId="PlaceId">
                          ...
                          <Form.Control
                            ...
                            name="PlaceId"
                            placeholder="PlaceId"
                            defaultValue={this.state.food.PlaceId}
                          />
                        </Form.Group>
